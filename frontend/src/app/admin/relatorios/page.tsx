...
function RelatoriosPage() {
  ...
  const inputCls = "bg-[#0d0f36] border border-white/8 rounded-lg px-3 py-2 text-xs text-slate-300 outline-none focus:border-[#69d2cd] transition-all w-full placeholder-slate-700";
    ...
    <div className="min-h-screen bg-[#0d0f36] text-[#f1f6ce]/90 font-sans" translate="no">
      ...
      <div className="p-5 space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-base font-semibold text-[#f1f6ce]">Relatório de Requisições</h2>
          ...
          <div className="flex gap-2">
            <button onClick={exportExcel} disabled={!!exporting || loading || filtered.length === 0}
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#b9f1d6]/80 text-[#0d0f36]/20 text-[#b9f1d6] border border-[#b9f1d6]/30 text-xs font-medium hover:bg-[#b9f1d6]/80 text-[#0d0f36]/30 transition-all disabled:opacity-40 disabled:cursor-not-allowed">
              {exporting === 'excel' ? (
        ...
        {/* Filtros */}
        <div className="bg-[#294380] border border-white/5 rounded-xl p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          {[
            { label: 'Total', value: metrics.total, color: 'text-[#69d2cd]', border: 'border-[#69d2cd]/20' },
            { label: 'Pendentes', value: metrics.pendente, color: 'text-amber-400', border: 'border-amber-500/20' },
            { label: 'Aprovados', value: metrics.aprovado, color: 'text-[#b9f1d6]', border: 'border-[#b9f1d6]/20' },
            ...
            <div key={label} className={`bg-[#294380] border ${border} rounded-xl p-4`}>
        ...
        {/* Tabela de preview */}
        <div className="bg-[#294380] border border-white/5 rounded-xl overflow-hidden">
              ...
              <tbody>
                ...
                {filtered.map((r, i) => {
                  ...
                  const stColor: Record<string, string> = {
                    ...
                    'Aprovado': 'text-[#b9f1d6] bg-[#b9f1d6]/10 border-[#b9f1d6]/20',
                  ...
                  return (
                    <tr key={r.id} className="border-b border-white/5 hover:bg-white/3 transition-colors">
                      ...
                      <td className="px-4 py-2.5 text-[#f1f6ce]/90">{r.engenheiro || '—'}</td>
