      ...
      <header className="flex items-center justify-between px-5 py-3 bg-[#161b2e] border-b border-white/5">
        ...
        <nav className="flex items-center gap-1">
          ...
          <a href="/admin/fornecedores"
            className="flex items-center gap-1.5 text-[10px] text-slate-500 hover:text-emerald-400 hover:bg-emerald-500/10 hover:border-emerald-500/30 border border-transparent px-3 py-1.5 rounded-lg transition-all font-medium">
